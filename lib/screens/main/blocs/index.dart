...
enum AuthStatus { auth, regisration }
...
class ChangeAuthStatusMainEvent extends MainEvent {
  final AuthStatus authStatus;
  ChangeAuthStatusMainEvent(this.authStatus);
}
...
class MainState {
  ...
  MainState copyWith({int page, AuthStatus authStatus, bool isBarVisible, bool isMBSheetVisible, bool hardChange}) {
    return MainState()
      ..page = page ?? this.page
...
class MainScreenBloc extends Bloc<MainEvent, MainState> {
  ...
  Stream<MainState> mapEventToState(
    ...
    if (event is ChangeAuthStatusMainEvent) yield currentState.copyWith(authStatus: event.authStatus);
  }
}
